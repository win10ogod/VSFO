"""Inference helper for the English V-SiFu checkpoint."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run V-SiFu inference on synthetic prompts")
...
def main() -> None:
    ...
    print("Top candidates (token :: cosine similarity):")
    ...
    print("\nTransport plan mass (source -> target :: mass):")
